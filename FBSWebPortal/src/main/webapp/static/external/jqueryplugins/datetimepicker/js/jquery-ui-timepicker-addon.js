	...
	$.extend(Timepicker.prototype, {
		...
		*/
		_injectTimePicker: function() {
			...
			if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
				...
				this.timezone_select = $tp.find('.ui_tpicker_timezone').append('<select style="width:150px;"></select>').find("select");
		...
		*/
		_controls: {
			...
			select: {
				create: function(tp_inst, obj, unit, val, min, max, step){
					var sel = '<select class="ui-timepicker-select" style="width:100px;" data-unit="'+ unit +'" data-min="'+ min +'" data-max="'+ max +'" data-step="'+ step +'">',
